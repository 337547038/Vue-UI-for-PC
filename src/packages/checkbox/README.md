...
<p>已选值：{{checkbox8}}</p>
<p>
<ak-checkbox-group v-model="checkbox8" :data="groupData"></ak-checkbox-group>
</p>
</template>
<script>
import {reactive, toRefs} from 'vue'
...
<p>已选值：{{checkbox9}}</p>
<p>
<ak-checkbox-group v-model="checkbox9" :data="groupData" :min="2" :max="4"></ak-checkbox-group>
</p>
</template>
<script>
import {reactive, toRefs} from 'vue'
...
<p>已选值：{{checkbox11}}</p>
<p>
<ak-checkbox-group v-model="checkbox11" :data="groupData" ref="checkGroup"></ak-checkbox-group>
</p>
<p>
...
<p>
<ak-checkbox-group v-model="checkbox2" :data="groupData" :beforeChange="beforeChangeGroup"></ak-checkbox-group>
</p>
</template>
<script>
import {reactive, toRefs} from 'vue'
